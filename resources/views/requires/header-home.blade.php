   ...
   <section class="elementor-section elementor-inner-section elementor-element elementor-element-0b7b2fc elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="0b7b2fc" data-element_type="section">
           ...
           <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-c6b7746" data-id="c6b7746" data-element_type="column">
               <div class="elementor-widget-wrap elementor-element-populated">
                   <div class="elementor-element elementor-element-56daf39 elementor-align-right elementor-widget elementor-widget-button" data-id="56daf39" data-element_type="widget" data-widget_type="button.default">
                       <div class="elementor-widget-container">
                           <div class="mainMenu elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('aboutUs') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">About Us</span> </span> </a> </div>
                           <div class="mainMenu elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('faq') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">FAQ</span> </span> </a> </div>
                           <div class="mainMenu elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('contact') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Contact</span> </span> </a> </div>
                           <div class="mainMenu elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('subscriptionPlans') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Pricing</span> </span> </a> </div>
                           <div class="mainMenu elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="https://diandental.myshopify.com/"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Shop</span> </span> </a> </div>
                           @if( !isset($hideSignin) || $hideSignin == FALSE)
                           <div class="elementor-button-wrapper" style="display:inline-block"> <a href="{{ route('signin') }}" class="signinBtn elementor-button-link elementor-button elementor-size-lg" role="button" style="  font-family: 'Roboto', Sans-serif; font-size: 17px; font-weight: 500; background-color: #D9AA5A; border-radius: 5px 5px 5px 5px; padding: 15px 15px 15px 15px;"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text">Sign In</span> </span> </a> </div>
                           @else
                           <div class="elementor-button-wrapper" style="display:inline-block"> <a href="{{ route('logout') }}" class="signinBtn elementor-button-link elementor-button elementor-size-lg" role="button" style="  font-family: 'Roboto', Sans-serif; font-size: 17px; font-weight: 500; background-color: #D9AA5A; border-radius: 5px 5px 5px 5px; padding: 15px 15px 15px 15px;"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text">Sign Out</span> </span> </a> </div>
                           @endif
                       </div>
                   </div>
               </div>
       ...
       <div class="mobileMenu">
            <div class="elementor-element elementor-element-a4aea0d elementor-widget elementor-widget-image " data-id="a4aea0d" data-element_type="widget" data-widget_type="image.default">
                <div class="elementor-widget-container contextMenu" id="contextMenuDiv">
                    <div class="">
                        <div class="elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('aboutUs') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">About Us</span> </span> </a> </div>
                        <div class=" elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('faq') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">FAQ</span> </span> </a> </div>
                        <div class=" elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('contact') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Contact</span> </span> </a> </div>
                        <div class="elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="{{ route('subscriptionPlans') }}"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Pricing</span> </span> </a> </div>
                        <div class="elementor-button-wrapper" style="display:inline-block; margin-right:10px"> <a href="https://diandental.myshopify.com/"> <span class="elementor-button-content-wrapper"> <span class="elementor-button-text" id="headerMenu">Shop</span> </span> </a> </div>
                    </div>
                </div>
            </div>
        </div>
