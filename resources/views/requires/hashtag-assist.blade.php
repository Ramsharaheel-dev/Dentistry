...
<style>
    ...
    .horizantalScrollHashtagMenu .leftHashtagArrow, .horizantalScrollHashtagMenu .rightHashtagArrow{
        position: absolute;
        height: 100%;
        top: 0;
        display: flex;
    ...
    .horizantalScrollHashtagMenu .leftHashtagArrow:hover, .horizantalScrollHashtagMenu .rightHashtagArrow:hover{
        background: #333;
...
<div class="horizantalScrollHashtagMenu">
    ...
    <ul>
        <li>
        <form action="{{ route('speechToTextNotes') }}" target=”_blank” style='display:inline !important;' method="GET">
            @csrf
                ...
                <div class="elementor-widget-container" style="padding:0 0 0 5px">
                    ...
                    <div class=" elementor-button-wrapper">
                        <div class="elementor-button-link elementor-button elementor-size-xs elementor-button-content-wrapper elementor-button-text" role="button">
                            <input class="hashtags" style="display: inline;" id="" type="submit" value="Speech To Text" name="nameOfHashtag" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
        <form action="{{ route('emailTemplate') }}" target=”_blank” style='display:inline !important;' method="GET">
            @csrf
            <div class="elementor-element elementor-element-51ed8f9 elementor-widget__width-auto elementor-widget elementor-widget-button" data-id="51ed8f9" data-element_type="widget" data-widget_type="button.default">
                <div class="elementor-widget-container" style="padding:0 0 0 5px">
                    ...
                    <div class=" elementor-button-wrapper">
                        <div class="elementor-button-link elementor-button elementor-size-xs elementor-button-content-wrapper elementor-button-text" role="button">
                            <input class="hashtags" style="display: inline;" id="" type="submit" value="Patient Email Sendor" name="nameOfHashtag" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
        <form action="{{ route('allTemplates') }}" target=”_blank” style='display:inline !important;' method="GET">
            @csrf
            <div class="elementor-element elementor-element-51ed8f9 elementor-widget__width-auto elementor-widget elementor-widget-button" data-id="51ed8f9" data-element_type="widget" data-widget_type="button.default">
                <div class="elementor-widget-container" style="padding:0 0 0 5px">
                    ...
                    <div class=" elementor-button-wrapper">
                        <div class="elementor-button-link elementor-button elementor-size-xs elementor-button-content-wrapper elementor-button-text" role="button">
                            <input class="hashtags" style="display: inline;" id="" type="submit" value="Notes: Templates" name="nameOfHashtag" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form action="{{ route('assistVideos') }}" style='display:inline !important;' method="GET">
            ...
            <div class="elementor-element elementor-element-51ed8f9 elementor-widget__width-auto elementor-widget elementor-widget-button" data-id="51ed8f9" data-element_type="widget" data-widget_type="button.default">
                <div class="elementor-widget-container" style="padding:0 0 0 5px">
                    ...
                    <div class=" elementor-button-wrapper">
                        <div class="elementor-button-link elementor-button elementor-size-xs elementor-button-content-wrapper elementor-button-text" role="button">
                            <input class="hashtags" style="display: inline;" id="" type="submit" value="Patient Explainer Videos" name="nameOfHashtag" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form action="{{ route('hashtag-filter') }}" style='display:inline !important;' method="GET">
            ...
            <div class="form-group">
                <input type="hidden" name="contentType" class="form-control" value="{{ $hashtag->nameOfContentSection }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="hidden" id="selectedHashtag" class="form-control" value="{{ $selectedHashtagValue }}">
            </div>
            @endisset
    ...
    if($("#selectedHashtag")){
        ...
        $("input[type='submit']").each(function() {
            if($(this).val() == $selectedHasthtag){
                $(this).parent('.elementor-button').css({"background-color":"#d9aa5a"});
            }
        });
    }
