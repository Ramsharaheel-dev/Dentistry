...
@section('custom_style')
    <style>
        .custom-btn {
            ...
            border: 0.1px solid #e6d2d2 !important;
            font-weight: 400 !important;
            /* border: 0px solid #e6d2d2 !important; */
        }
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="py-4">
                            ...
                            <p class="assign-p" style="display: none;">Please select the videos you’d like to assign</p>
                        </div>
                    </div>
                    <div class="col-md-6 ">
            ...
            <div class="row">
                @if (session('finalReels'))
                    @foreach ($finalReels as $finalReel)
                        <div
                            class="col-md-4 col-sm-12 col-xs-12 videoContainer @if (isset($assignedVideos) && in_array($reel->id, $assignedVideos)) assign-borders @endif">
                            ...
                            <div class="mt-5" style="padding:56.25% 0 0 0;position:relative;">
                                <iframe class="videoIframe" id="videoIframe-{{ $finalReel->id }}"
                                    src="{{ $finalReel->url }}" data-video-id="{{ $finalReel->id }}"
                                    data-reel-duration="{{ $finalReel->duration }}" frameborder="0"
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <p class="percentage" id="percentageWatched-{{ $finalReel->id }}">Watched: 0%</p>
                        ...
                        <div
                            ...
                            <div class="round" style="display: none">
                                <input type="checkbox" class="selectButton" id="checkbox{{ $reel->id }}"
                                    data-video-id="{{ $reel->id }}" data-src="{{ $reel->url }}"
                                    data-video-type="reel" />
                                <label class="selectCheckbox" for="checkbox{{ $reel->id }}"
                                    style="display: none;"></label>
                            </div>
                            <div class="mt-5" style="padding:56.25% 0 0 0;position:relative;">
                                <iframe class="videoIframe" id="videoIframe-{{ $reel->id }}" src="{{ $reel->url }}"
                                    data-video-id="{{ $reel->id }}" data-reel-duration="{{ $reel->duration }}"
                                    data-video-type="reel" frameborder="0" allow="autoplay; fullscreen; picture-in-picture"
                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    @if (isset($assignedVideosData[$reel->id]))
                                        ...
                                        <p class="deadline-fonts2">End Date:
                                            {{ $assignedVideosData[$reel->id]['end_date'] }}</p>
                                    @endif
                                </div>
                                <div class="col-md-6">
