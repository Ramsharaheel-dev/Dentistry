...
@section('content')
    <div class="content-body">
        ...
        <div class="container-fluid ">
            <div class="row">
                <div
                    class="col-md-4 col-sm-12 col-xs-12 videoContainer @if (in_array($podcast->id, $assignedVideos)) assign-borders @endif">
                    <div class="round" style="display: none">
                        <input type="checkbox" class="selectButton" id="checkbox{{ $podcast->id }}"
                            data-video-id="{{ $podcast->id }}" data-src="{{ $podcast->url }}" data-video-type="podcast" />
                        <label class="selectCheckbox" for="checkbox{{ $podcast->id }}" style="display: none;"></label>
                    </div>
                    <div class="mt-5" style="padding:56.25% 0 0 0;position:relative;">
                        <iframe class="videoIframe" id="videoIframe-{{ $podcast->id }}" src="{{ $podcast->url }}"
                            data-video-id="{{ $podcast->id }}" data-video-type="podcast" data-reel-duration="{{ $podcast->duration }}"
                    ...
                    <div class="row pt-3">
                        <div class="col-md-6">
                            @if (isset($assignedVideosData[$podcast->id]))
                                <p class="deadline-fonts">End Time:
                                    {{ \Carbon\Carbon::parse($assignedVideosData[$podcast->id]['end_time'])->format('h:i A') }}
                                </p>
                                <p class="deadline-fonts2">End Date:
                                    {{ $assignedVideosData[$podcast->id]['end_date'] }}
                                </p>
                            @endif
                        </div>
                        <div class="col-md-6">
                            <p class="percentage" id="percentageWatched-{{ $podcast->id }}">Watched: 0%</p>
