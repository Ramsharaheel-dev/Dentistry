                            ...
                            <div class="row">
                                ...
                                @if($privilege == '3')
                                    ...
                                    <div class="col-lg-2" style="padding:0">
                                        <a class="deletePost" style="color: white;
                                        text-decoration: none;
                                        background-color: #D70040;
                                        padding: 10px 20px;
                                        border-radius: 5px;"
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-4 col-xs-4">
                                            <div class="row">
                                                <div class="col-lg-1">
                                                    <img class="image" src="../../storage/app/profile_pics/{{ $thread->userProfile }}">
                                                </div>
                                                <div class="col-lg-11" style="padding:0">
                                                    <span class="content" style="margin-left:10px">{{ $thread->userName }}</span>
                                                </div>
                                            </div>
                                        </div>
