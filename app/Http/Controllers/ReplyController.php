...
class ReplyController extends Controller
{
    public function store(Request $request)
    {
        ...
        return response()->json(['status' => true, 'reply' => $reply, 'replies_count' => $replies_count, 'comment_replies_count' => $comment_replies_count, 'displayComments' => $displayComments]);
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if ($reply) {
            ...
            return response()->json(['status' => true, 'comment_id' => $commentId, 'displayComments' => $displayComments, 'replies_count' => $replies_count, 'comment_replies_count' => $comment_replies_count]);
        }
